    ...
    <el-card class="page-card">
      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="140px" class="form-container">
        <el-form-item label="单据编号">
          <el-input :value="detail?.bizDocNo" disabled style="width: 400px" />
        </el-form-item>
...
import { mockShareChangeDocs, mockShareholders, mockAccounts, mockCurrencies, type ShareChangeDetail } from '@/data/mockData'
...
const loadData = () => {
  ...
  form.tradeTime = record.tradeTime
  form.changeType = record.changeType
  form.shareholderId = record.shareholderId
  form.accountId = record.accountId
  form.amount = record.amount
  form.currencyCode = record.currencyCode
  form.exchangeRate = record.exchangeRate

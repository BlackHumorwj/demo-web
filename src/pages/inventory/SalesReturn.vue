  ...
  <div class="page-container">
    <div class="page-header">
      <div class="search-bar">
        ...
        <el-select v-model="customerId" placeholder="客户" class="filter-select" clearable>
      ...
      <el-button type="primary" @click="handleAdd">新增销售退货</el-button>
    </div>
...
import { mockSalesReturnDocs, mockContacts } from '@/data/mockData'
...
const filteredList = computed(() => {
  let list: SalesReturnDoc[] = [...mockSalesReturnDocs]
...
const handleAdd = () => {
  router.push('/inventory/sales-return/add')
}

const handleView = (id: string) => {
  router.push(`/inventory/sales-return/view/${id}`)
}

const handleEdit = (id: string) => {
  router.push(`/inventory/sales-return/edit/${id}`)
}
